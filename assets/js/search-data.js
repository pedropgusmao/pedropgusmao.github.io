      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-sparkles-our-work-decentralized-training-of-3d-lane-detection-with-automatic-labeling-using-hd-maps-was-accepted-at-the-vehicular-technology-conferece-vtc2023-spring",
          title: ':sparkles: Our work Decentralized Training of 3D Lane Detection with Automatic Labeling Using...',
          description: "",
          section: "News",},{id: "news-sparkles-thrilled-to-announce-that-our-submission-to-the-nist-privacy-enhancing-technologies-prize-challenge-has-won-trophy-first-prize-trophy-please-see-the-video-announcement-from-the-summit-for-democracy-introduced-by-dsit-secretary-michelle-donelan-here-more-information-can-be-found-at-the-following-links-the-updated-pets-prize-challenges-website-is-available-here-the-uk-hmg-press-release-here-the-white-house-press-release-here-blog-profiling-the-uk-winners-here",
          title: ':sparkles: Thrilled to announce that our submission to the NIST Privacy-Enhancing Technologies Prize...',
          description: "",
          section: "News",},{id: "news-our-paper-l-dawa-layer-wise-divergence-aware-weight-aggregation-in-federated-self-supervised-visual-representation-learning-was-accepted-at-iccv-2023",
          title: 'Our paper “L-DAWA: Layer-wise Divergence Aware Weight Aggregation in Federated Self-Supervised Visual Representation...',
          description: "",
          section: "News",},{id: "news-sparkles-i-am-joining-the-nice-research-group-at-the-university-of-surrey-as-a-lecturer-in-computer-science",
          title: ':sparkles: 📢 I am joining the NICE Research Group at the University of...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://bsky.app/profile/pedropbg.bsky.social", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/pedropgusmao", "_blank");
        },
      },{
        id: 'social-dblp',
        title: 'DBLP',
        section: 'Socials',
        handler: () => {
          window.open("https://dblp.org/pid/88/10808", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=TfdVttMAAAAJ", "_blank");
        },
      },{
        id: 'social-work',
        title: 'Work',
        section: 'Socials',
        handler: () => {
          window.open("https://www.surrey.ac.uk/people/pedro-porto-buarque-de-gusmao", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%70.%6D%79_%76%65%72%79_%6C%61%73%74_%6E%61%6D%65@%73%75%72%72%65%79.%61%63.%75%6B", "_blank");
        },
      },{
      id: 'light-theme',
